        ...
        return (
          <div
            ...
            className={
              ...
              (isHovered
                ? "hover:bg-white/5 hover:border-t-1 hover:border-t-white/10 hover:inset-shadow-[0_10px_30px_rgba(0,0,0,0)] hover:backdrop-blur-[1px] hover:inset-shadow-white/8"
                : isOther
                  ? "text-zinc-500"
